...
class TestOpenAIClientInit:
    ...
    def test_ollama_uses_localhost_default_base_url(self, monkeypatch):
        monkeypatch.delenv("INSIGHT_OLLAMA_BASE_URL", raising=False)
    ...
    def test_ollama_uses_base_url_from_env(self, monkeypatch):
        monkeypatch.setenv("INSIGHT_OLLAMA_BASE_URL", "http://ollama.internal:11434")
    ...
    def test_ollama_config_base_url_overrides_env(self, monkeypatch):
        monkeypatch.setenv("INSIGHT_OLLAMA_BASE_URL", "http://env-host:11434")
