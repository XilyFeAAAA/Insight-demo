...
class InsightOrchestrator:
    ...
    async def run(self, force_hours: int = None) -> None:
        ...
        """
        self.console.print(
            "[bold cyan]🌅 Insight - Starting aggregation...[/bold cyan]\n"
        )
        ...
        try:
            ...
            for lang in self.config.ai.languages:
                ...
                try:
                    ...
                    front_matter = (
                        "---\n"
                        "layout: default\n"
                        f'title: "Insight Summary: {today} ({lang.upper()})"\n'
                        f"date: {today}\n"
                        f"lang: {lang}\n"
                        "---\n\n"
                    )
                ...
                if (
                    ...
                    subject = f"Insight Summary ({lang.upper()}) - {today}"
            ...
            self.console.print(
                "[bold green]✅ Insight completed successfully![/bold green]"
            )
