"""Webhook notification service for Insight."""
                ...
                "header": {
                    "title": {
                        ...
                        "content": (
                            f"Insight {date} 折叠日报"
                            if lang == "zh"
                            else f"Insight {date} Collapsible Daily"
                        ),
                    },
                    "template": "blue",
                },
        ...
        return [
            {
                **base_vars,
                "message_title": (
                    f"Insight {date} 日报" if lang == "zh" else f"Insight {date} Daily"
                ),
        ...
        await self.notify(
            {
                ...
                "result": "failed",
                "timestamp": str(int(datetime.now(timezone.utc).timestamp())),
                "message_title": "Insight generation failed",
