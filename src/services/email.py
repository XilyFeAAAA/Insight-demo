                            ...
                            if sender:
                                ...
                                if email_addr and "@" in email_addr:
                                    ...
                                    if email_addr not in subscribers:
                                        ...
                                        self._send_reply(
                                            email_addr,
                                            "Subscribed to Insight",
                                            "You have been successfully subscribed to Insight daily summaries.",
                                        )
                            ...
                            if sender:
                                ...
                                if email_addr and "@" in email_addr:
                                    ...
                                    if email_addr in subscribers:
                                        ...
                                        self._send_reply(
                                            email_addr,
                                            "Unsubscribed from Insight",
                                            "You have been successfully unsubscribed from Insight daily summaries.",
                                        )
