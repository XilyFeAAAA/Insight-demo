...
欢迎来到 [Insight](https://github.com/thysrael/Insight)，一个 AI 驱动的信息聚合系统。

## 文档

- [配置指南](configuration) — AI 提供商、信息源、过滤规则与环境变量替换
- [信息源采集器](scrapers) — Insight 如何从 GitHub、Hacker News、RSS、Reddit 采集内容
...
Welcome to [Insight](https://github.com/thysrael/Insight), an AI-driven information aggregation system.

## Documentation

- [Configuration Guide](configuration) — AI providers, information sources, filtering, and environment variable substitution
- [Source Scrapers](scrapers) — How Insight collects content from GitHub, Hacker News, RSS, and Reddit
